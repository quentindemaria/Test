...
- Les différentes parties d’`Openedition.org <https://www.openedition.org />`_ (portail générique qui regroupe tout) :
	...
	- `lodel.hypotheses.org <lodel.hypotheses.org/>`_ : Blog Lodel, billets des différentes releases déployées
	...
	- `maisondesrevues.org <maisondesrevues.org/>`_ : doc pour revues.org et books.openedition.org
